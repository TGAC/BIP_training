...
plant_population_id = create_record('plant_population',
  name: 'BnaDFFS2016_PAG_schowcase', # for workshop: put your groupe number behind the population, as we are all using the same population and don't want to produce duplicates.
  description: 'a  great population with a lot of diversity',
...
# add the column number from your CSV beside the correct variable.
ACCESSION_NAME = 0
LINE_NAME = 3
VARIETY = 4
ACCESSION_SOURCE =1
